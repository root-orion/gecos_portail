            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="list-unstyled team-info mb-0">
                        <li class="mr-4">Rerecent Chat</li>
                            ...
                            <div class="card-body chat_windows">
                                <ul class="mb-0">
                                    ...
                                    <li class="other-message">
                                        ...
                                        <div class="message">
                                            <div class="media_img">
                                                <img src="../assets/images/gallery/1.jpg" class="w150 img-thumbnail" alt="" />
                                                <img src="../assets/images/gallery/2.jpg" class="w150 img-thumbnail" alt="" />
                                            </div>
                                            <span class="time" >10:15 AM, Today</span>
                                        </div>
                                    </li> 
                                    ...
                                    <li class="my-message">
                                        <div class="message">
                                            <div class="media_img">
                                                <img src="../assets/images/gallery/3.jpg" class="w100 img-thumbnail" alt="" />
                                                <img src="../assets/images/gallery/4.jpg" class="w100 img-thumbnail" alt="" />
                                                <img src="../assets/images/gallery/5.jpg" class="w100 img-thumbnail" alt="" />
                                                <img src="../assets/images/gallery/6.jpg" class="w100 img-thumbnail" alt="" />
                                            </div>
                                            <span class="time">10:25 AM, Today</span>
                                        </div>
                                    </li>
