            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Dep-all">Departements</a></li>
                                ...
                                <table class="table table-hover table-striped table-vcenter text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Dakoury</td>
                                            <td>+225 4567890589</td>
                                            <td>daryt@live.com</td>
                                            <td>2014</td>
                                            <td>150</td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td>Computer Engg.</td>
                                            <td>Assane Potho michel</td>
                                            <td>+225 0757491524</td>
                                            <td>passat@gmail.com</td>
                                            <td>2011</td>
                                            <td>205</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>M.B.A.</td>
                                            <td>Abale Joseph</td>
                                            <td>+225 8863890214</td>
                                            <td>jabale@gmail.com</td>
                                            <td>2018</td>
                                            <td>128</td>
